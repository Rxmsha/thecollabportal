        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card className="border-0 overflow-hidden">
            ...
            <CardContent className="p-6 bg-white space-y-6">
              <p className="text-base text-gray-700 font-mono">Update your personal information</p>
              ...
              <div className="grid gap-6 sm:grid-cols-2">
                <div className="space-y-2">
                  <Label htmlFor="firstName" className="font-mono text-sm uppercase tracking-wider text-gray-500">
                    First Name
                  </Label>
                  <Input
                    id="firstName"
                ...
                <div className="space-y-2">
                  <Label htmlFor="lastName" className="font-mono text-sm uppercase tracking-wider text-gray-500">
                    Last Name
                  </Label>
                  <Input
                    id="lastName"
              ...
              <div className="grid gap-6 sm:grid-cols-2">
                <div className="space-y-2">
                  <Label htmlFor="email" className="font-mono text-sm uppercase tracking-wider text-gray-500">
                    Email
                  </Label>
                  <Input
                    id="email"
                  ...
                  />
                  <p className="text-xs text-gray-400 font-mono">Email cannot be changed</p>
                </div>
                <div className="space-y-2">
          ...
          <Card className="border-0 overflow-hidden">
            <div className="px-6 py-4 flex items-center gap-3" style={{ backgroundColor: brandColor }}>
              ...
              <span className="text-white font-mono font-semibold uppercase tracking-wider text-base">Notifications</span>
            </div>
            <CardContent className="p-6 bg-white space-y-6">
              <p className="text-base text-gray-700 font-mono">Manage your email notification preferences</p>

              <div className="flex items-center justify-between py-4 border-t border-gray-100">
                <div className="space-y-1">
                  <p className="font-mono font-medium text-gray-900 uppercase tracking-wider text-base">New Template Notifications</p>
        ...
        <div className="space-y-6">
          ...
          <Card className="border-0 overflow-hidden">
            <div className="px-6 py-4 flex items-center gap-3" style={{ backgroundColor: brandColor }}>
              ...
              <span className="text-white font-mono font-semibold uppercase tracking-wider text-base">Your Plan</span>
            </div>
            <CardContent className="p-6 bg-white space-y-6">
              <div className="flex items-center justify-between py-2">
                <span className="text-gray-600 font-mono uppercase tracking-wider text-sm">Status</span>
              ...
              <div className="flex items-center justify-between py-2 border-t border-gray-100">
                <span className="text-gray-600 font-mono uppercase tracking-wider text-sm">Billing Period</span>
                <span className="font-mono font-medium text-gray-900">Monthly</span>
              </div>
              <div className="border-t border-gray-100 pt-4">
                <Button
                  variant="outline"
                  className="w-full rounded-none font-mono uppercase tracking-wider text-sm h-10"
                  onClick={() => {
